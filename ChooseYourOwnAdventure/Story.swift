...
enum Story {
    ...
    var artwork: UIImage {
        switch self {
        case .returnTrip: return UIImage(imageLiteralResourceName: "ReturnTrip")
        case .touchDown: return UIImage(imageLiteralResourceName: "TouchDown")
        case .homeward: return UIImage(imageLiteralResourceName: "Homeward")
        case .rover: return UIImage(imageLiteralResourceName: "Rover")
        case .cave: return UIImage(imageLiteralResourceName: "Cave")
        case .crate: return UIImage(imageLiteralResourceName: "Crate")
        case .monster: return UIImage(imageLiteralResourceName: "Monster")
        case .droid: return UIImage(imageLiteralResourceName: "Droid")
        case .home: return UIImage(imageLiteralResourceName: "Home")
        }
    }
